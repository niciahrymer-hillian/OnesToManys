...
class Product(db.Model):
    ...
    order_origin = db.Column(db.String(80), nullable=False, default="Online")
    sales_channel = db.Column(db.String(80), nullable=False, default="Direct")
    ...
    def to_dict(self):
        ...
        return {
            ...
            "order_origin": self.order_origin,
