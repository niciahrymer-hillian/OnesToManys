...
// Initial state for the manufacturer creation form
...
// Formatters for analytics display
...
function App() {
  ...
  // On mount, load all products for analytics
  useEffect(() => {
    loadAllProducts()
  }, [])


  // When selected manufacturer changes, load its details
  useEffect(() => {
    let isMounted = true
  ...
  // Create a new product for the selected manufacturer
  ...
  // Update a product for the selected manufacturer
  ...
  // Delete a product for the selected manufacturer
