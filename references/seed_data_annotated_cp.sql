...
-- [WHY] Deterministic but high-variance synthetic seed formulas for clearer analytics differences.
-- [EFFECT] Produces visible spread across manufacturer totals, channels, regions, and category coverage charts.
