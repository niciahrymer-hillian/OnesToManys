// [FILE] index_annotated_cp.js
// [WHY] Boots the Vanilla home page and displays backend readiness.
// [EFFECT] Gives users immediate feedback that API + dataset are available, then exposes the seed catalog as navigable buttons.
